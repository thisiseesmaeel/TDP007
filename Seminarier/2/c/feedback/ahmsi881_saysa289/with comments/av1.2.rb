...
def getArrayF(array)
  ...
  for item in array do
    ...
    ## ----- DISKUSSION ------
    ## VI TROR ATT KONVERTERA ETT REGEX-MATCH-OBJEKT SOM ÄR REDAN EN STRÄNG
    ## BEHÖVER MAN INTE ANVÄNDA (TO_S.TO_I) IGEN.
...
def minDifferenceF(array)
  ...
  while i < minArray.size 
    ...
    ##FINT MED ATT ANVÄNDA RUBY METOD (MIN)
...
def getDataW(file)
  File.open file do |file|
      ...
      ## "*" TECKEN SKULLE INTE VARA NÅGOT PROBLEM I DET HÄR FALLET,
      ## DÅ VI BORTSÅG IFRÅN "*" I VÅR REGEX-MATCHNING OCH FICK INGA PROBLEM.

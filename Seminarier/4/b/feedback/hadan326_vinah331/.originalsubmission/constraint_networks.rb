...
def celsius2fahrenheit
  fahrenheit_conn = Connector.new("fahrenheit")
  celsius_conn = Connector.new("celsius")
  add = Connector.new("add")
  multi = Connector.new("multi")
  add.user_assign(32)
  multi.user_assign(1.8)
  res = Connector.new("res")
  Multiplier.new(celsius_conn, multi, res)
  Adder.new(res, add, fahrenheit_conn)
  return [celsius_conn, fahrenheit_conn]
end

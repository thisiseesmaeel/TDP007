...
class ConstraintParser < Parser
  ...
  def get_connector (arithmeticCon)
    if arithmeticCon.a.name.match(/(\W)/)
      return arithmeticCon.a

    elsif arithmeticCon.b.name.match(/(\W)/)
      return arithmeticCon.b

    elsif arithmeticCon.out.name.match(/(\W)/)
      return arithmeticCon.out
    end
  end

...
def celsius2fahrenheit
  ...
  constant = ConstantConnector.new("constant", 32)
  factor = ConstantConnector.new("factor", 1.8)
  add_mult_connector = Connector.new ("add -> multiply")
  
  Multiplier.new( c, factor, add_mult_connector)
  Adder.new( add_mult_connector, constant, f )

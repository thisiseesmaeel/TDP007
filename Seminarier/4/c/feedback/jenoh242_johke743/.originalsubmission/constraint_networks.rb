...
def celsius2fahrenheit
  ...
  nine.user_assign(9)
  cNine = Connector.new("9c")

  f = Connector.new("f")
  fMinus = Connector.new("f-32")
  thirtytwo = Connector.new("32")
  thirtytwo.user_assign(32)
  five = Connector.new("5")
  five.user_assign(5)

  Multiplier.new(c, nine, cNine)
  Multiplier.new(fMinus, five, cNine)
  Adder.new(fMinus, thirtytwo, f)
...
def test_celsius2farenheit
  ...
  puts f.value.to_s #212

  c.user_assign 0

  puts f.value.to_s #32

  c.forget_value "user"

  f.user_assign 100

  puts c.value.to_s #37

end

#celsius2fahrenheit()
#test_celsius2farenheit()
